...
namespace MLA.OrderManagement.Infrustructure.Migrations
{
    ...
    [Migration("20210820170230_intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MLA.ClientOrder.Domain.Entities.Layers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MLA.ClientOrder.Domain.Entities.Orders", b =>
                {
                    b.HasOne("MLA.ClientOrder.Domain.Entities.Layers", "LeadLayer")
                        .WithMany()
                    ...
                    b.OwnsOne("System.Collections.Generic.List<MLA.ClientOrder.Domain.Values.LawFirmInvolved>", "LawFirmInvolved", b1 =>
                        {
                            b1.Property<Guid>("OrdersId")
                                .HasColumnType("uniqueidentifier");
